...
class Writer:
    ...
    def __init__(self, out_path, samples, command):
        ...
        self.vcf_writer.write('##FORMAT=<ID=SCORE,Number=1,Type=Float,Description="Score of the consensus call">\n')
        self.vcf_writer.write('##FORMAT=<ID=GTS,Number=1,Type=String,Description="Method(s) that support the consensus call">\n')
